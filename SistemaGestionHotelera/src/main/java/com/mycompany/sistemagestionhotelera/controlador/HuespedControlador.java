...
public class HuespedControlador {
    ...
    public boolean registrarHuesped(String nombre, String documento, String telefono, String email, String tipo) {
        //Aplicacion del Patrón GOF Factory
        ...
        // Log de Auditoria en consola para demostrar el uso del patrón en la sustentación
        ...
        //Envío de los datos validados a la capa DAO para persistencia en MySQL
